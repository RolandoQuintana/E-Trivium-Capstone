...
void loop() {  
  ...
  if (central) {
    ...
    while (central.connected()) {
      ...
      // SOS LEAF: Arduino detects when SOS button has been pressed and sends "SOS" string to the app so app can SMS contacts
      //**TODO** -- uncomment below then add some code for sos button press detection
      // if ( sos button press detected by Arduino ) {
      ...
      //**TODO** -- Jess: health/posture things


      // LIGHT LEAF: Checks for color &/or pattern requests from the app and handles them
