...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/lightLeafSettings',
          builder: (context, params) => LightLeafSettingsWidget(
        ...
        FFRoute(
          name: 'AddCustomContact',
          path: '/addCustomContact',
          builder: (context, params) => AddCustomContactWidget(),
        ),
        FFRoute(
          name: 'SplashPage',
          path: '/splashPage',
